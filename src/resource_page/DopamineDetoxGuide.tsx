      ...
      <div className="bg-white border-b border-gray-200">
        <div className="w-full max-w-none mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl">
            Why you can scroll Reels for 2 hours but can't read a textbook for 10 minutes. And how to fight back.
          </p>
        </div>
      </div>
      ...
      <div className="w-full max-w-none mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
        ...
        <section>
          ...
          <p className="text-gray-700 text-lg mb-8">
            You aren't "lazy." You are up against thousands of engineers at TikTok, Instagram, and YouTube whose only job is to hack your brain's reward system.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="bg-red-50 p-6 rounded-xl border border-red-100">
              ...
              <p className="text-red-800 mb-4">
                Every time you swipe, your brain gets a tiny hit of dopamine (the pleasure chemical). It's a "variable reward schedule"—like a slot machine. You never know if the next video will be funny, so you keep pulling the lever.
              </p>
              <div className="bg-white p-3 rounded text-sm text-red-700 italic border border-red-200">
                "Just one more video..." turns into 2 AM.
              </div>
            </div>
            ...
            <div className="bg-blue-50 p-6 rounded-xl border border-blue-100">
              ...
              <p className="text-blue-800 mb-4">
                Constant scrolling trains your brain to expect a reward every 15 seconds. Real life—like reading, studying, or even talking to friends—feels boring because it moves too slow.
              </p>
            ...
            left={
              <div className="space-y-4">
                ...
                <p className="text-gray-600">
                  Cal Newport, author of <em>Deep Work</em>, argues that the ability to focus without distraction is becoming increasingly rare and valuable.
                </p>
                ...
                <p className="text-gray-600 mt-4">
                  Reclaiming your focus isn't just about grades; it's about reclaiming your <strong>life</strong>.
                </p>
              </div>
            }
            right={
              <div className="bg-gray-900 rounded-xl p-8 text-white h-full flex flex-col justify-center text-center">
                 ...
                 <p className="text-gray-400">
                   If you aren't paying for the product, you are the product. Your attention is being sold. Take it back.
                 </p>
              </div>
            }
          />
        ...
        <section className="pt-12 border-t border-gray-200">
          ...
          <p className="text-gray-700 text-lg mb-8">
            You don't need to throw away your phone. You just need to set boundaries.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <Card variant="hover">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Work for 25 minutes, break for 5. Your brain can handle "boring" if it knows a break is coming.
              </p>
            </Card>
            ...
            <Card variant="hover">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Turn your screen black and white. Suddenly, Instagram looks a lot less appetizing. It strips away the visual "sugar."
              </p>
            </Card>
            ...
            <Card variant="hover">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Put your phone in another room while studying. "Out of sight, out of mind" is a scientific fact.
              </p>
            </Card>
          </div>
        </section>
        ...
        {/* Conclusion */}
        <div className="bg-red-500 text-white rounded-2xl p-8 md:p-12 text-center">
          ...
          <p className="text-red-100 text-lg max-w-2xl mx-auto mb-8">
             Embrace boredom. It's in the quiet moments—not the noisy ones—that your best ideas will come.
          </p>
        </div>
